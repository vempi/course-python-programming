...
**Namun**, dalam kondisi nyata di lapangan, hasil pengurangan tersebut **jarang sekali nol**. Hal ini terjadi karena sebagian air yang masuk ke dalam tanah tersimpan sementara di dalam pori-pori tanah dan tidak langsung mengalir menuju **titik keluar (outlet) DAS**. Istilah "Neraca Air" digunakan karena kita akan melakukan analisis terhadap air yang masuk dan keluar. Selisih air masuk dan air keluar dicatat sebagai **Perubahan Simpanan ($\Delta S$)**.
